...
def compute_score(solution_str: str, 
    ...
    """
    preference_level 1: 格式对了，答案对了， score = 3
    preference_level 2: 格式对了，答案错了， score = -0.5
    preference_level 3: 格式对了，答案不全， score = -1
    preference_level 4: 格式错了， score = -1
    """
    ...
    if not preference_reward:
        ...
        return total_score, preference_level
