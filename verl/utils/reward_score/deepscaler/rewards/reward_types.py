...
class RewardConfig:
    ...
    # # DeepScaler General reward constants.
    # correct_reward: float = 1.0
    # incorrect_reward: float = -1.0
    # format_error_reward: float = -1.0
    # unk_error_reward: float = -1.0
    correct_reward: float = 3.0 # full right
    incorrect_reward: float = -0.5 # wrong answer
    format_error_reward: float = -3.0 # wrong format
    unk_error_reward: float = -1.0 # incomplete answer
