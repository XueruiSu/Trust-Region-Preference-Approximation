...
class RewardManager():
    ...
    def __call__(self, data: DataProto, preference_reward=False):
        ...
        for i in range(len(data)):
            ...
            if not preference_reward:
                ...
                score, preference_level = compute_score_fn(solution_str=sequences_str, ground_truth=ground_truth, preference_reward=preference_reward)
                preference_levels.append(preference_level)
        ...
        if not preference_reward:
            ...
            return reward_tensor, torch.tensor(preference_levels)
